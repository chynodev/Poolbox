    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your PoolBox Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to PoolBox";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your PoolBox Account";
                    ...
                    public static LocalText FormTitle = "Sign up for PoolBox";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "PoolBox";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText FooterCopyright = "Copyright (c) 2021.";
                public static LocalText FooterInfo = "PoolBox";
